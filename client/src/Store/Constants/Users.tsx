...
export const POST_COHORTE_TO_USER = "POST_COHORTE_TO_USER";
...
export const PUT_PASS_FOR_EMAIL = "PUT_PASS_FOR_EMAIL";
export const MAKE_USER_EDITABLE = "MAKE_USER_EDITABLE";